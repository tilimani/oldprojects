...
#reopen to test that worked correctly
test = pd.read_csv('/Users/alex/desktop/user_csv.csv')

#manually checking first 10 against sessions data
test.head(10)
...
#check that types are the same between files
test.dtypes
