...
<div style="line-height:5px;font-size:1px">&#160;</div><!--[if mso]></td></tr></table><![endif]-->
  ...
  <div style="font-family:'Quattrocento', 'Trebuchet MS', Helvetica, sans-serif;color:#555555;line-height:150%; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;"> 
    <div style="font-size:12px;line-height:18px;font-family:Quattrocento, 'Trebuchet MS', Helvetica, sans-serif;color:#555555;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: justify"><span style="font-size: 16px; line-height: 24px;">¡Genial! Cada vez estas más cerca de encontrar tu VICO. Ahora, sólo debes confirmar tu voluntad de pago del depósito y {{$manager_name}} te dará un tiempo de 48 horas para realizar el pago. ¡No pierdes el tiempo!</span></p></div>  
  </div>
  <!--[if mso]></td></tr></table><![endif]-->
</div>
...
<div align="center" class="button-container center " style="padding-right: 10px; padding-left: 10px; padding-top:10px; padding-bottom:10px;">
  <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top:10px; padding-bottom:10px;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://www.getvico.com/notification" style="height:34pt; v-text-anchor:middle; width:193pt;" arcsize="33%" strokecolor="#ea960f" fillcolor="#ea960f"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:'Quattrocento', 'Trebuchet MS', Helvetica, sans-serif; font-size:18px;"><![endif]-->
    <a href="https://www.getvico.com/notification" target="_blank" style="display: block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #ea960f; border-radius: 15px; -webkit-border-radius: 15px; -moz-border-radius: 15px; max-width: 258px; width: 218px;width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 5px; padding-right: 20px; padding-bottom: 5px; padding-left: 20px; font-family: 'Quattrocento', 'Trebuchet MS', Helvetica, sans-serif;mso-border-alt: none">
      <span style="font-family:'Quattrocento', 'Trebuchet MS', Helvetica, sans-serif;font-size:16px;line-height:32px;"><span style="font-size: 18px; line-height: 36px;"><strong>Quiero pagar mi depósito</strong></span></span>
    </a>
