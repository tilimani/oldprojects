      ...
      <div class="modal-dialog modal-lg modal-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
              ...
              <div class="row mb-4">
                ...
                <div class="col-9 pr-0 pr-md-4">
                  <ul class="bullet-points-off">
                    ...
                    <li><p class="font-weight-light text-justify">Primero un potencial inquilino solicita la reserva de una de tus habitaciones.</p>
                    </li>
                  </ul>
                </div>
              ...
              <div class="row mb-4">
                ...
                <div class="col-9 pr-0 pr-md-4">
                  <ul class="bullet-points-off">
                    ...
                    <li><p class="font-weight-light text-justify">Puedes aceptar la solicitud y invitar al interesado a tu VICO. Al aceptar, le brindas un plazo de 24 horas de exclusividad para realizar el pago de reserva (la primera renta mensual).</p>
                    </li>
                  </ul>
                </div>
                {{-- END PROCESS EXPLANATION --}}
              ...
              <div class="row mb-4">
                ...
                <div class="col-9 pr-0 pr-md-4">
                  <ul class="bullet-points-off">
                    ...
                    <li><p class="font-weight-light text-justify">Apenas el interesado realiza el pago de reserva, te llega una notificación con la confirmación de reserva. Recibirás el pago, apenas el inquilino llega y nos confirma que la habitación y la VICO se encuentra en las condiciones comunicadas en la plataforma.</p>
                    </li>
                  </ul>
                </div>
                {{-- END PROCESS EXPLANATION --}}
            ...
            <p class="text-center font-weight-">Próximos pasos: Facilita los pagos online de las rentas mensuales.</p>
          </div>
