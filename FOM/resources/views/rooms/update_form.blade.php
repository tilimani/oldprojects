    ...
    <div class="card">
        ...
        <div id="roomForm">
                ...
                <div class="card-body col-md-8 col-sm-12">
                    ...
                    <div class="row steps" name="step0" id="step0">
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-space">
                                <input type="text" class="form-control" id="nickname" value="{{$room->nickname}}">
                        ...
                        <div class="col-12">
                            <div class="select-equip">
                                <div class="row equip-selector justify-content-center">
                                    @if (\Carbon\Carbon::parse($room->available_from)->year == 9999)
                                    <div class="col-6 col-sm-3 equip form-check">
                                        <input class="bookeable" type="radio" id="isBookeable" name="bookable" value="1">
                                    ...
                                    <div class="col-6 col-sm-3 equip form-check">
                                        <input class="bookeable" type="radio" id="isnotBookeable" name="bookable" value="0" checked>
                    ...
                    <div id="noRented">
                            ...
                            <div class="col-12">
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <div class="m-0 d-md-inline">
                                        <p class="d-inline">$</p>
                                        <input id="priceRoom" class='d-inline w-50 form-control form-control-sm verifiableRoom' maxlength="32" type='number' min='1' value="{{$room->price}}" required>
                                ...
                                <div class="select-equip">
                                    <div class="row equip-selector justify-content-center mt-0">
                                        @if (intval($room->price_for_two) === 0)
                                        <div class="col-6 col-sm-3 equip form-check">
                                        ...
                                        @else    
                                        <div class="col-6 col-sm-3 equip form-check">
                                            <input class="couple" type="radio" name="canCouple" id="coupleAff" value="1" checked>
                                            <label for="coupleAff">
                                                <span class="icon-check vico-room-equip"></span>
                                            </label>
                                            <p for="coupleAff">Si</p>
                                        ...
                                        <div class="col-6 col-sm-3 equip form-check">
                                            <input class="couple" type="radio" name="canCouple" id="coupleNeg" value="0">
                                            <label for="coupleNeg">
                                                <span class="icon-close vico-room-equip"></span>
                                            </label>
                                            <p for="coupleNeg">No</p>
                                ...
                                @else
                                    ...
                                    <p class="mr-2 pl-0 d-inline"> Renta mensual para dos personas: </p>
                                        <div class="m-0 d-md-inline">
                                            <p class="d-inline">$</p>
                                        <input id="priceForTwo" class='d-inline w-50 form-control form-control-sm verifiableRoom' value="{{intval($room->price_for_two)}}" type='number' maxlength="32" min='1' required>
                                            <p class="d-inline ">COP</p>
                                        </div>
                                    </div>
                                @endif
                        ...
                        <div class="row steps" name="step3" id="step3">
                            ...
                            <div class="col-12">
                                ...
                                <div class="select-equip">
                                    ...
                                    <div class="equip-selector row justify-content-center">
                                        <div class="col-4 col-sm-3 equip">
                                            @if (intval($devices->tv) === 1)
                                                <input type="checkbox" name="has_tv" value="1" id="device_tv" checked>
                                                <label for="device_tv">
                                        ...
                                        <div class="col-4 col-sm-3 equip">
                                            @if (intval($devices->closet) === 1)
                                                <input type="checkbox" name="has_closet" value="1" id="device_closet" checked>
                                        ...
                                        <div class="col-4 col-sm-3 equip">
                                            @if (intval($devices->desk) === 1)
                                                <input type="checkbox" name="desk" value="1" id="device_desk" checked>
                                ...
                                <div class="select-equip ">
                                    ...
                                    <div class="equip-selector row justify-content-center">
                                        @switch($devices->windows_type)
                                            @case('afuera')
                                                <div class="col-6 col-sm-3 equip">
                                                    <input type="radio" value='afuera' name="window_type"  class="form-check window" id="window1" checked>
                                                    <label for="window1">
                                                ...
                                                <div class="col-6 col-sm-3 equip">
                                                    <input type="radio" value='sin_ventana' class="window" name="window_type" id="window4">
                                                    <label for="window4">
                                                        <span class="icon-close vico-room-equip"></span>
                                                    </label>
                                            ...
                                            @case('patio')
                                                ...
                                                <div class="col-6 col-sm-3 equip">
                                                    <input type="radio" value='patio' class="window" name="window_type" id="window2" checked>
                                                    <label for="window2">
                                                        <span class="icon-plant-black vico-room-equip"></span>
                                                    </label>
                                                    <p for="window2">Hacia el patio</p>
                                            ...
                                            @case('adentro')
                                                ...
                                                <div class="col-6 col-sm-3 equip">
                                                    <input type="radio" value='adentro' class="window" name="window_type" id="window3" checked>
                                                    <label for="window3">
                                                        <span class="icon-lamp vico-room-equip"></span>
                                                    </label>
                                                    <p for="window3">Hacia adentro</p>
                                        ...
                                        <div class="select-equip ">
                                            ...
                                            <div class="equip-selector row justify-content-center">
                                                @switch($devices->bed_type)
                                                    ...
                                                    @case('semi-doble')
                                                        <div class="col-4 col-sm-3 equip">
                                                            <input type="radio" value='sencilla' name="bed_type"  class="form-check" id="typeBedRadio1"  >
                                                            <label for="typeBedRadio1">
                                                                <span class="icon-bed-single vico-room-equip"></span>
                                                            </label>
                                                            <p for="typeBedRadio1">Sencilla</p>
                                                        ...
                                                        <div class="col-4 col-sm-3 equip">
                                                            <input type="radio" value='semi-doble' name="bed_type" id="typeBedRadio2" checked>
                                                            <label for="typeBedRadio2">
                                                                <span class="icon-bed-semi-double vico-room-equip"></span>
                                                            </label>
                                                            <p for="typeBedRadio2">Semi-doble</p>
                                                    ...
                                                    @case('doble')
                                                        ...
                                                        <div class="col-4 col-sm-3 equip">
                                                            <input type="radio" value='doble' name="bed_type" id="typeBedRadio3" checked>
                                                            <label for="typeBedRadio3">
                                                                <span class="icon-bed-double vico-room-equip"></span>
                                                            </label>
                                                            <p for="typeBedRadio3">Doble</p>
                                        ...
                                        <div class="select-equip ">
                                            ...
                                            <div class="equip-selector row justify-content-center">
                                                @if ($devices->bath_type === 'Privado')
                                                    <div class="col-6 col-sm-3 equip">
                                                        <input type="radio" value='Privado' name="bath_type"  class="form-check" id="typeBathRadio1" onclick="bath_shared.disabled=true"  checked>
                                                    ...
                                                    <div class="col-6 col-sm-3 equip">
                                                        <input type="radio" class="form-check" value='Compartido con:' name="bath_type" onclick="bath_shared.disabled = false; focusBathShared()" id="typeBathRadio2">
                                                        ...
                                                        <div class="">
                                                            <input id="numBathShared" type="number" min="1" name="bath_shared" class="d-inline form-control form-control-sm col-4 ml-1 mr-1 verifiableRoom" required disabled>
                                                ...
                                                @else
                                                    ...
                                                    <div class="col-6 col-sm-3 equip">
                                                        ...
                                                        <p for="typeBathRadio2" class="mb-0">Compartido con: </p>
                                                        <div class="">
                                                        <input type="text" id="numBaths" value="{{$devices->bath_type}}" style="d-none">
                        ...
                        <div class="row steps" name="step4" id="step4">
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <textarea class="form-control" id="description" maxlength="766">{{$room->description}}</textarea>
                            </div>
                        ...
                        <div class="row steps" name="step5" id="step5">
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <div class="col-12">
                                    @if ($room->available_from <= \Carbon\Carbon::today()->toDateString())
                                        <div class="select-equip ">
                                            <div class="equip-selector row justify-content-center">
                                                <div class="col-6 col-sm-3 equip">
                                    ...
                                    @elseif(\Carbon\Carbon::parse($room->available_from)->year == 9999)
                                        <div class="select-equip ">
                                            <div class="equip-selector row justify-content-center">
                                                <div class="col-6 col-sm-3 equip">
                                                    <input class="form-check availableInput" type="radio" name="isAvailable" id="dispoRadio1" value="1">
                                                    {{-- <input type="radio" value='Privado' name=""  class="form-check" id=""  > --}}
                                                    <label for="dispoRadio1">
                                                        <span class="icon-check vico-room-equip"></span>
                                                    </label>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input availableInput d-none" type="radio" name="isAvailable" id="dispoRadio3" value="3" checked>
                                            <label class="form-check-label" for="dispoRadio3">
                                            {{-- Nunca (si es la tuya) --}}
                                            </label>
                                        </div>
                                    @else
                                        <div class="select-equip ">
                                            <div class="equip-selector row justify-content-center">
                                                ...
                                                <div class="col-6 col-sm-3 equip">
                                                    <input class="form-check mt-2 availableInput" type="radio" name="isAvailable" id="dispoRadio2" value="2" checked>
                                                    <label for="dispoRadio2">
                                                    <span class="icon-close vico-room-equip "></span>
                                                    </label>
                                                    <div class="dispoRadio2">
                                                        <p for="dispoRadio2">No</p>
                                                        <span id="currentDate" value="{{$room->available_from}}" style="d-none"></span>                                                                                                   
                                                        <input class="form-control form-control-sm verifiableRoom d-block" min="{{$today_date}}" style="background-color: white" type="date" id="unavailable" autocomplete="off" placeholder="Date" readonly required value="{{$room->available_from}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="row steps unavailableRoom" id="unavailableRoom" name="step6">
                        ...
                        @if (isset($booking->user))
                            ...
                            <input type="hidden" id="user_id" value="{{$booking->user_id}}">
                            <div class="col-12">
                                <div class="select-equip ">
                                    <div class="row equip-selector justify-content-center mb-3">
                                        ...
                                        @else
                                            <div class="col-6 col-sm-3 equip form-check">
                                                <input type="radio" name="gender" value="1" id="create-male" >
                                                <label for="create-male">
                                                    <span class="icon-man vico-room-equip"></span>
                                                </label>
                                            </div>
                                            <div class="col-6 col-sm-3 equip form-check">
                                                <input type="radio" name="gender" value="2" id="create-female" checked>
                                                <label for="create-female">
                                                    <span class="icon-woman vico-room-equip"></span>
                                                </label>
                                            </div>
                                ...
                                <div class="mb-3 ">
                                    ...
                                    <select class="custom-select verifiableRoom" id="country" required>
                                        <option value="" selected>-- Seleccione --</option>
                                        @foreach($countries as $country)
                                            @if ($booking->user->country_id === $country->id)
                                ...
                                <div class="">
                                    <p > ¿Como se llama? </p>
                                    <input id="roomieName" type="text" class="form-control verifiableRoom" value="{{$booking->user->name}}" required>
                                </div>
                            </div>
                        @else
                            <div class="col-12">
            ...
            <div class="row justify-content-end m-3 ">
                <button type="button" class="btn btn-primary col-4 col-md-2" id-room="{{$room->id}}" id="update">Siguiente</button>
            </div>
            {{-- END CONTINUE BUTTON --}}
        </div>
        {{-- END COLLAPSE --}}
