                    ...
                    <div class="grayz">
                        ...
                        <div class="borderme row">
                            <div class="col-lg-8 col-sm-8 padding-left-no">
                                <h3 class="zui"><img class="Profilimgsml" src="img/icon-jan-1.png"> <font>Metodo de pago</font> Tarjeta de Crédito: <span>xxxx xxxx xxxx 3390</span></h3>
                            </div>
                            <div class="col-lg-4 col-sm-4 padding-right-no">
                                <button class="btn-col-1 hover-opc" data-toggle="modal" data-target="#myModal1">Cambiar</button>
                            </div>
                        </div>
                        <!-- rounded box -->
                        <div class="borderme row">
                            <div class="col-lg-8 col-sm-8 padding-left-no">
                                <h3 class="zui"><img class="Profilimgsml" src="img/icon-jan-2.png"> <font>Final de mi estancia:</font> 27.03.2019</h3>
                            </div>
                            <div class="col-lg-4 col-sm-4 padding-right-no">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                          ...
                                          <span class="btn-col-2a f2 hover-opc">En proceso</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Hab 1 - VICO EXITO</td>
                                        ...
                                        <td>
                                          ...
                                          <span class="btn-col-2b f2 hover-opc">Pending</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Hab 1 - VICO EXITO</td>
                                        ...
                                        <td>
                                          ...
                                          <span class="btn-col-2c f2 hover-opc">Pagado</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Hab 1 - VICO EXITO</td>
                                        ...
                                        <td>
                                          ...
                                          <span class="btn-col-2d f2 hover-opc">Rechazado</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
