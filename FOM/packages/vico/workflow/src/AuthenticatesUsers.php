...
trait AuthenticatesUsers
{
    ...
    public function login(Request $request)
    {
        ...
        return redirect($url)->with('error_mail_paswwd','Correo y/o contraseña incorrectos');
    ...
    protected function sendLoginResponse(Request $request)
    {
        ...
        if (Carbon::parse($user->created_at) < Carbon::createFromFormat('Y-m-d', '2019-04-01')) {
        ...
        AlertController::getInstance()->Init($user->id,$request->path());
